...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF9] text-[#18181B] flex flex-col justify-between items-center font-sans p-4 sm:p-6 antialiased selection:bg-blue-100 selection:text-blue-900">
      <Head>
        <title>Create Account | Career Page Builder</title>
        ...
        <div className="bg-white border border-[#E4E4E7] rounded-xl p-6 sm:p-8 shadow-xs">
          ...
          <div className="text-center mb-6">
            ...
            <p className="font-inter text-xs text-[#71717A] leading-relaxed">
              Start building your company&apos;s careers page
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-xs font-semibold text-[#18181B] mb-1.5">
                Full Name
              </label>
              <input
                id="name"
            ...
            <div>
              <label htmlFor="companyName" className="block text-xs font-semibold text-[#18181B] mb-1.5">
                Company Name
              </label>
              <input
                id="companyName"
            ...
            <div>
              <label htmlFor="password" className="block text-xs font-semibold text-[#18181B] mb-1.5">
                Password
              </label>
              <input
                id="password"
